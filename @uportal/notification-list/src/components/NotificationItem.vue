  ...
  <article class="notification-item-container">
    ...
    >
      ...
      <div class="media-body">
        <h4 class="mt-0">
          {{ notification.title }}
          <span class="text-muted" v-if="notification.dueDate"
            >- Due {{ notification.dueDate | dueDate }}</span
          >
        </h4>
      ...
      <div
        class="media-actions"
        v-if="
          notification.availableActions && notification.availableActions.length
        "
      >
